...
echo "  Model cache:      ./volumes/xinference"
echo ""
echo -e "${YELLOW}Note:${NC}"
echo "  Embedding and rerank models are downloaded on first launch."
echo "  Model download size varies: BGE-M3 ~2.3 GB, BGE-reranker-v2-m3 ~1.1 GB."
