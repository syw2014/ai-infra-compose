...
assert_file_exists "${MINIO_DIR}/setup_minio.sh"
...
assert_contains "${MINIO_DIR}/docker-compose.yml" "./volumes/data:/data"
...
assert_contains "${MINIO_DIR}/deploy_minio.sh" "./setup_minio.sh"
assert_contains "${MINIO_DIR}/deploy_minio.sh" "compose up -d"

assert_executable_hint "${MINIO_DIR}/setup_minio.sh"
assert_contains "${MINIO_DIR}/setup_minio.sh" "mkdir -p ./volumes/data"
